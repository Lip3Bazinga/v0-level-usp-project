...
export function FinalCta({
  ...
  description = "Junte-se a milhares de brasileiros aprendendo programação com a metodologia da USP. Sem mensalidade, sem pegadinhas — só conhecimento de qualidade.",
}: FinalCtaProps) {
  return (
