    ...
    <div className="min-h-screen bg-white">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 border-b border-gray-100 bg-white/80 backdrop-blur-md">
        <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex items-center gap-3">
            <button className="hidden text-sm font-medium text-[#7C3AED] hover:text-[#4C1D95] transition-colors sm:block">
              Entrar
            </button>
            <Link href="/ide">
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col items-center justify-between gap-8 md:flex-row">
            ...
            <div className="flex items-center gap-8">
              <Link href="/" className="text-sm text-gray-600 hover:text-[#7C3AED]">
                Design System
              </Link>
              <Link href="/ide" className="text-sm text-gray-600 hover:text-[#7C3AED]">
                IDE
              </Link>
              <Link href="/perfil" className="text-sm text-gray-600 hover:text-[#7C3AED]">
                Perfil
              </Link>
            </div>
